...
public class CodificaCaratteristicaCollaudoTM extends TableManager {
	...
	public static final String TABLE_NAME = SystemParam.getSchema("THIPPERS") + "SGQ_COD_CAR_COL";

	private static TableManager cInstance;

	private static final String CLASS_NAME = it.mame.thip.qualita.controllo.CodificaCaratteristicaCollaudo.class.getName();

	public synchronized static TableManager getInstance() throws SQLException{
		if (cInstance == null) {
			cInstance = (TableManager) Factory.createObject(CodificaCaratteristicaCollaudoTM.class);
		}
		return cInstance;
	}

	public CodificaCaratteristicaCollaudoTM() throws SQLException{
		super();
	}
