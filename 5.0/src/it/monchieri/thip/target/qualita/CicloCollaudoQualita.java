...
public class CicloCollaudoQualita extends CicloCollaudoImportatore {
	...
	public CicloCollaudoTestata codificaCicloCollaudoPanthera(OrdEsecAtvSogCollaudo collaudo,
		...
		CicloCollaudoTestata ciclo = testataCicloCollaudo(collaudo);
		...
		if(!ciclo.isOnDB()) {
			...
			CicloCollaudoCaratteristica caratt = caratteristicaCicloCollaudo(faseDimensionalePostLM1, (short) 1, "Positivo / Negativo", "Pos. / Neg.",collaudo);
			caratt.setRilavLimInfTol(true);
			caratt.setRilavLimSupTol(true);
			caratt.setTipoCaratteristica('2');

			faseDimensionalePostLM1.getCaratteristiche().add(caratt);
